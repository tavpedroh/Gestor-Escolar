package controller.Disciplina.frm;
...
public class DisciplinaServlet extends HttpServlet{
    ...
    // Método que busca um Disciplina por ID
    private String buscarUm(int id) {
        DisciplinaDao disDao = new DisciplinaDao();
        Disciplina disciplina = null;
        try {
            disciplina = disDao.listar(id); // Passa o ID para o método listarUm
    ...
    // Método que busca disciplinas por nome (filtro)
    private String buscarVarios(String query) {
        DisciplinaDao disDao = new DisciplinaDao();
        List<Disciplina> disciplinas = null;
        try {
            disciplinas = disDao.listarUm(query); // Método para listar disciplinas com o nome passado
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int idCur = disciplina.getCurso().getId(); // Supondo que venha assim no JSON
